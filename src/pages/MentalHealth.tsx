...
import { Brain, Heart, MessageCircle, Calendar, Shield, Activity, Sun, Moon, Mic, MicOff } from 'lucide-react';
...
const MentalHealth = () => {
  ...
  // Update userPrompt as transcript updates
  useEffect(() => {
    if (transcript) {
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    resetTranscript(); // reset so transcript doesn't conflict with manual input
  };

  const handleSpeakPrompt = () => {
    if (userPrompt.trim()) {
      speak(userPrompt.trim());
    }
  };
  ...
  const toggleListening = () => {
    if (isListening) {
      stopListening();
      // Optionally, speak or do something after stop
    } else {
      startListening();
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="p-6 md:p-8">
            ...
            {/* Voice prompt input with mic */}
            <div className="mb-12">
              <h2 className="text-xl font-semibold text-gray-800 mb-4">Speak or type your thoughts</h2>
              <div className="flex items-center space-x-4">
                <input
                  ...
                  placeholder="Type or use mic to speak your thoughts..."
              ...
              <p className="mt-2 text-sm text-gray-500">
                Use the microphone to speak your thoughts or type manually. Then press Speak to hear it aloud.
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <button
                  ...
                  onClick={() =>
                    speak("I'm glad you're feeling good! Would you like to maintain this positive mood with some mindfulness exercises?")
                  }
                >
                ...
                <button
                  ...
                  onClick={() =>
                    speak("It's okay to feel neutral. Would you like to explore some activities to boost your mood?")
                  }
                >
                ...
                <button
                  ...
                  onClick={() =>
                    speak("I understand you're feeling anxious. Would you like to try a quick breathing exercise?")
                  }
                >
                ...
                <button
                  ...
                  onClick={() =>
                    speak("I'm here to support you. Would you like to talk to a mental health professional?")
                  }
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {therapists.map((therapist, index) => (
                  <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
                    <img src={therapist.image} alt={therapist.name} className="w-full h-48 object-cover" />
                    <div className="p-4">
